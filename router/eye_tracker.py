...
def eye_tracker():
    try:
        ...
        for label in order:
            ...
            w_int_y = 0.7 - 0.4 * normalized_avg_y
            w_ext_y = 1 - w_int_y
        ...
        click_threshold_seconds = 1.5
        double_click_threshold_seconds = 4.0
        stationary_distance_threshold = 25
        ...
        speak_text('동기화가 완료되었습니다. 마우스 제어를 시작합니다. 화면 중앙을 바라봐주세요.')
        ...
        while True:
            ...
            if distance < stationary_distance_threshold:
                ...
                if time.time() - last_stationary_time > double_click_threshold_seconds:
